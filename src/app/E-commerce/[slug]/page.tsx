...
export default function ProductDetailPage({ params }: { params: { slug: string } }) {
  ...
  if (!product) {
    return (
      ...
      >
        <p className="text-red-500 text-xl animate-pulse">Divine connection lost - Product not found!</p>
      </motion.div>
    );
  }
  ...
  const handleWishlist = () => {
    ...
    toast.success(isWishlisted ? "Removed from wishlist" : `${product.name} added to wishlist!`, {
      position: "top-right",
    });
  };
            ...
            <div className="flex flex-col justify-between">
              <div>
                <div className="flex items-center justify-between mb-4">
                  ...
                  {product.discount > 0 && (
                    <span className="bg-orange-500 text-white text-sm font-bold py-1 px-3 rounded">Sale!</span>
                  )}
                </div>
                ...
                <div className="mb-4">
                  <span className="text-2xl font-bold text-gold">₹{(product.price + priceAdjustment).toFixed(2)}</span>
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
                {relatedProducts.map((relatedProduct) => {
                  const slugifiedRelatedName = relatedProduct.name.toLowerCase().replace(/\s+/g, "-");
                  return (
                    <Link key={relatedProduct.id} href={`/E-commerce/${slugifiedRelatedName}`}>
                      <motion.div
                        whileHover={{ scale: 1.05 }}
                      ...
                      >
                        ...
                        <div className="p-4">
                          ...
                          <div className="mt-2">
                            <span className="text-gold font-bold">₹{relatedProduct.price.toFixed(2)}</span>
