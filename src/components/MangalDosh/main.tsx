...
export default function MangalDoshPuja() {
  ...
  const content = {
    english: {
      title: "Mangal Dosh Puja in Ujjain",
      freeConsult: "Get Your Free Call Consultation Now!",
      marqueeText: "Free Call Now!",
      subtitle:
        "With the guidance of Mangal Dosh expert Pandit Deepak Goutam, find spiritual solutions for harmony in relationships and a peaceful life.",
      pujaSteps: [
        {
          step: "Sankalp",
          desc: "Initiate with a sacred vow to appease Mars.",
          icon: "🌟",
          color: "from-yellow-400 to-orange-500",
        },
        {
          step: "Hawan",
          desc: "Purify energies with a holy fire ritual.",
          icon: "🔥",
          color: "from-orange-500 to-red-500",
        },
        {
          step: "Mantra Jaap",
          desc: "Chant powerful Vedic mantras for blessings.",
          icon: "📿",
          color: "from-red-500 to-purple-500",
        },
        {
          step: "Puja Samapti",
          desc: "Conclude with offerings for peace and balance.",
          icon: "🙏",
      ...
      features: [
        {
          ...
          desc: "Profound knowledge of rituals to mitigate Mangal Dosh.",
          icon: "🕉️",
        },
        {
          title: "Sacred Ujjain",
        ...
        },
        {
          ...
          desc: "Customized rituals to address your specific concerns.",
          icon: "✨",
        },
      ],
      footerQuote:
    ...
    hindi: {
      title: "उज्जैन में मंगल दोष पूजा",
      freeConsult: "अभी अपनी मुफ्त कॉल परामर्श प्राप्त करें!",
      marqueeText: "कॉल करें!",
      subtitle:
        "मंगल दोष विशेषज्ञ पंडित दीपक गौतम की मार्गदर्शन में, रिश्तों में सामंजस्य और शांतिपूर्ण जीवन के लिए आध्यात्मिक समाधान पाएं।",
      pujaSteps: [
        {
          step: "संकल्प",
          desc: "मंगल ग्रह को शांत करने के लिए पवित्र संकल्प।",
          icon: "🌟",
          color: "from-yellow-400 to-orange-500",
        },
        {
        ...
        {
          step: "मंत्र जाप",
          desc: "आशीर्वाद के लिए शक्तिशाली वैदिक मंत्रों का जाप।",
          icon: "📿",
          color: "from-red-500 to-purple-500",
        },
        {
          step: "पूजा समाप्ति",
          desc: "शांति और संतुलन के लिए प्रसाद के साथ समापन।",
          icon: "🙏",
          color: "from-purple-500 to-orange-400",
        },
      ],
      ...
      features: [
        {
          ...
          desc: "मंगल दोष निवारण के लिए गहन अनुष्ठान ज्ञान।",
          icon: "🕉️",
        },
        {
          title: "पवित्र उज्जैन",
        ...
        },
        {
          ...
          desc: "आपकी विशिष्ट समस्याओं के लिए अनुकूलित अनुष्ठान।",
          icon: "✨",
        },
      ],
      footerQuote:
