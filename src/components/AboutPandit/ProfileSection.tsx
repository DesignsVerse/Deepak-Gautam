...
const ProfileSection = () => {
  return (
    <div className="w-full bg-gradient-to-br from-gray-100 to-gray-50 shadow-lg rounded-xl"> {/* Gradient BG + Shadow */}
      <div className="p-8"> {/* थोड़ा ज्यादा padding ताकि content breathe कर सके */}
        <div className="flex flex-col md:flex-row items-center">
          ...
          {/* Content Section */}
          <div className="text-gray-800 md:w-1/2 mt-6 md:mt-0 md:ml-10"> {/* Spacing Better Ki */}
            ...
            <p className="mb-4 text-lg leading-relaxed">
              पंडित जी के मार्गदर्शन में करवाई गई पूजा न केवल नकारात्मक ऊर्जा और बाधाओं का नाश करती है, 
              बल्कि भक्तों को सकारात्मकता, आत्मविश्वास और समृद्धि की प्राप्ति होती है।
            </p>
            <p className="mb-6 text-lg leading-relaxed">
              यदि आप माँ बगलामुखी की दिव्य कृपा और शक्ति का अनुभव करना चाहते हैं, 
              तो पंडित नंदकिशोर जोशी जी से संपर्क करें और अपने लिए शुभ अनुष्ठान व पूजा का आयोजन करवाएँ।
            </p>
